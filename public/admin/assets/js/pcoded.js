...
function setLayout() {
    ...
    main_layout_change(t),
        null !== t &&
            ...
            "horizontal" === t
                ? (document.querySelector(".pc-sidebar").classList.add("d-none"), (e.src = "../assets/js/layout-horizontal.js"), document.body.appendChild(e))
                : "color-header" === t
                ? document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/logo-white.svg")
                : "compact" === t
                ? ((e.src = "../assets/js/layout-compact.js"), document.body.appendChild(e))
                : "tab" === t && ((e.src = "../assets/js/layout-tab.js"), document.body.appendChild(e))),
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var e = document.querySelector("#mobile-collapse"),
                ...
                (e &&
                    e.addEventListener("click", function () {
                        document.querySelector(".pc-sidebar") &&
                            (document.querySelector(".pc-sidebar").classList.contains("mob-sidebar-active")
                                ? rm_menu()
            ...
            e =
                (e &&
                    e.addEventListener("click", function () {
                        document.querySelector(".pc-sidebar").classList.contains("pc-sidebar-hide")
                ...
                document.querySelector(".trig-drp-search") &&
                    document.querySelector(".trig-drp-search").addEventListener("shown.bs.dropdown", (e) => {
    ...
    "true" == e
        ? (document.getElementsByTagName("body")[0].setAttribute("data-pc-theme_contrast", "true"),
          document.querySelector(".theme-contrast .btn.active") &&
              (document.querySelector(".theme-contrast .btn.active").classList.remove("active"), document.querySelector(".theme-contrast .btn[data-value='true']").classList.add("active")))
        : (document.getElementsByTagName("body")[0].setAttribute("data-pc-theme_contrast", "false"),
          document.querySelector(".theme-contrast .btn.active") &&
              (document.querySelector(".theme-contrast .btn.active").classList.remove("active"), document.querySelector(".theme-contrast .btn[data-value='false']").classList.add("active")));
}
...
function main_layout_change(e) {
    ...
    document.getElementsByTagName("body")[0].setAttribute("data-pc-layout", e),
        document.querySelector(".pct-offcanvas") &&
            ((t = document.querySelector(".theme-main-layout > a.active")) && t.classList.remove("active"), (t = document.querySelector(".theme-main-layout > a[data-value='" + e + "']"))) &&
    ...
    "true" == e
        ? ((rtl_flag = !0),
          ...
          document.querySelector(".theme-direction .btn.active") &&
              (document.querySelector(".theme-direction .btn.active").classList.remove("active"), document.querySelector(".theme-direction .btn[data-value='true']").classList.add("active")))
        : ((rtl_flag = !1),
          ...
          document.querySelector(".theme-direction .btn.active") &&
              (document.querySelector(".theme-direction .btn.active").classList.remove("active"), document.querySelector(".theme-direction .btn[data-value='false']").classList.add("active")));
}
function layout_change(e) {
    ...
    t && t.classList.remove("active"),
        "dark" == e
            ? ((dark_flag = !0),
              document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/logo-white.svg"),
              document.querySelector(".navbar-brand .logo-lg") && document.querySelector(".navbar-brand .logo-lg").setAttribute("src", "../assets/images/logo-white.svg"),
              document.querySelector(".auth-main.v1 .auth-sidefooter") && document.querySelector(".auth-main.v1 .auth-sidefooter img").setAttribute("src", "../assets/images/logo-white.svg"),
              document.querySelector(".footer-top .footer-logo") && document.querySelector(".footer-top .footer-logo").setAttribute("src", "../assets/images/logo-white.svg"),
              document.querySelector(".theme-layout .btn.active") && (document.querySelector(".theme-layout .btn.active").classList.remove("active"), document.querySelector(".theme-layout .btn[data-value='false']").classList.add("active")))
            : ((dark_flag = !1),
              document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/logo-dark.svg"),
              document.querySelector(".navbar-brand .logo-lg") && document.querySelector(".navbar-brand .logo-lg").setAttribute("src", "../assets/images/logo-dark.svg"),
              document.querySelector(".auth-main.v1 .auth-sidefooter") && document.querySelector(".auth-main.v1 .auth-sidefooter img").setAttribute("src", "../assets/images/logo-dark.svg"),
              document.querySelector(".footer-top .footer-logo") && document.querySelector(".footer-top .footer-logo").setAttribute("src", "../assets/images/logo-dark.svg"),
              document.querySelector(".theme-layout .btn.active") && (document.querySelector(".theme-layout .btn.active").classList.remove("active"), document.querySelector(".theme-layout .btn[data-value='true']").classList.add("active")));
}
        ...
        ("true" == e
            ? (document.querySelector(".pc-content").classList.add("container"),
              ...
              document.querySelector(".theme-container .btn.active") &&
                  (document.querySelector(".theme-container .btn.active").classList.remove("active"), document.querySelector(".theme-container .btn[data-value='true']").classList.add("active")))
            : (document.querySelector(".pc-content").classList.remove("container"),
              ...
              document.querySelector(".theme-container .btn.active") &&
                  (document.querySelector(".theme-container .btn.active").classList.remove("active"), document.querySelector(".theme-container .btn[data-value='false']").classList.add("active"))));
}
